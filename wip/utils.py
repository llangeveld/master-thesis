...
def load_full_files():
    ...
    """
    EMEA_en_f = open("/home/lonneke/thesis/local/data/full_sent_datasets/EMEA/full.en")
    EMEA_de_f = open("/home/lonneke/thesis/local/data/full_sent_datasets/EMEA/full.de")
    GNOME_en_f = open("/home/lonneke/thesis/local/data/full_sent_datasets/GNOME/full.en")
    GNOME_de_f = open("/home/lonneke/thesis/local/data/full_sent_datasets/GNOME/full.de")
    JRC_en_f = open("/home/lonneke/thesis/local/data/full_sent_datasets/JRC/full.en")
    JRC_de_f = open("/home/lonneke/thesis/local/data/full_sent_datasets/JRC/full.de")
