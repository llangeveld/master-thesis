...
START=/data/s3225143
DOMAIN="EMEA"
DATA=$START/data/3_anonymized/processed/$DOMAIN.de-en
MODEL_DIR=$START/models/finetune-anon/de-en/$DOMAIN/checkpoint_best.pt
...
DOMAIN="JRC"
DATA=$START/data/4_translation/processed/$DOMAIN.de-en
MODEL_DIR=$START/models/finetune-anon/de-en/$DOMAIN/checkpoint_best.pt
